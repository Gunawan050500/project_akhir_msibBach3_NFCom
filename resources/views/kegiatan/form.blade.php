...
<div class="col-md-12">
        ...
        @csrf
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control @error('nama') is-invalid @enderror" name="nama" value="{{old('nama')}}" placeholder="Nama Kegiatan">
                    @error('nama')
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="date" class="form-control @error('tgl_kegiatan') is-invalid @enderror" name="tgl_kegiatan" value="{{old('tgl_kegiatan')}}" placeholder="Tanggal Kegiatan">
                    @error('tgl_kegiatan')
                    <div class="invalid-feedback">
                    {{$message}}
                    </div>
