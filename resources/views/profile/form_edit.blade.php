...
<div class="col-md-12">
    ...
    @endif
    <form method="GET" action="{{route('profile.update', $data->id)}}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control" name="no_hp" value="{{$data->no_hp}}" placeholder="No HP">
            </div>
        </div>
        ...
        <fieldset class="row mb-3">
            ...
            <div class="col-sm-10">
                <div class="form-check ml-6" style="margin-left: 7%">
                    ...
                    @php $check = ($status == $data->status) ? 'checked' : ''; @endphp
        ...
        <fieldset class="row mb-3">
            ...
            <div class="col-sm-10">
                <div class="form-check ml-6" style="margin-left: 8%">
                    ...
                    @php $check = ($role == $data->role) ? 'checked' : ''; @endphp
                    <div class="col-lg-7">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                ...
                @if(!empty($data->foto)) <img src="{{url('admin/images')}}/{{$data->foto}}" alt="Profile"
