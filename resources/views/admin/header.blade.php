<header class="navbar pcoded-header navbar-expand-lg navbar-light header-dark">
    ...
    <div class="m-header">
        ...
        <a href="#!" class="b-brand">
            ...
            <img src="{{ url ('admin/images/logo.png') }}" alt="" class="logo">
            <img src="{{ url ('admin/images/logo-icon.png') }}" alt="" class="logo-thumb">
        </a>
                    ...
                    <div class="dropdown-menu dropdown-menu-left profile-notification ">
                        <ul class="pro-body">
                            ...
                            <li><a href="email_inbox.html" class="dropdown-item"><i class="fas fa-circle"></i> My
                                    Messages</a></li>
                            <li><a href="auth-signin.html" class="dropdown-item"><i class="fas fa-circle"></i> Lock My
                                    MessagesScreen</a></li>
                        </ul>
                    </div>
                </div>
                        ...
                        <div class="row no-gutters">
                            ...
                            <div class="col">
                                ...
                                <ul class="pro-body">
                                    ...
                                    <li><a href="#!" class="dropdown-item"><i class="feather icon-minus"></i>
                                            Masking</a></li>
                                    <li><a href="#!" class="dropdown-item"><i class="feather icon-minus"></i> Wizard</a>
                                    </li>
                                    <li><a href="#!" class="dropdown-item"><i class="feather icon-minus"></i> Picker</a>
                                    </li>
                                    <li><a href="#!" class="dropdown-item"><i class="feather icon-minus"></i> Select</a>
                                    </li>
                                </ul>
                            </div>
                            <div class="col">
                                ...
                                <ul class="pro-body">
                                    <li><a href="#!" class="dropdown-item"><i class="feather icon-mail"></i> Email</a>
                                    </li>
                            ...
                            <div class="col">
                                ...
                                <ul class="pro-body">
                                    ...
                                    <li><a href="#!" class="dropdown-item"><i class="feather icon-file-minus"></i>
                                            Invoice</a></li>
                                    <li><a href="#!" class="dropdown-item"><i class="feather icon-calendar"></i> Full
                                            calendar</a></li>
                                    <li><a href="#!" class="dropdown-item"><i class="feather icon-upload-cloud"></i>
                                            File upload</a></li>
                                    <li><a href="#!" class="dropdown-item"><i class="feather icon-scissors"></i> Image
                                            cropper</a></li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="dropdown-menu dropdown-menu-right notification">
                        ...
                        <ul class="noti-body">
                            ...
                            <li class="notification">
                                <div class="media">
                                    <img class="img-radius" src="{{ url ('admin/images/user/avatar-1.jpg') }}"
                            ...
                            <li class="notification">
                                <div class="media">
                                    <img class="img-radius" src="{{ url ('admin/images/user/avatar-2.jpg') }}"
                                        alt="Generic placeholder image">
                                    <div class="media-body">
