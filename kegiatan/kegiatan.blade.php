            ...
            <div class="row g-5">
                    ...
                    <div class="row g-5">
                        <div class="col-md-6 wow slideInUp" data-wow-delay="0.1s">
                            ...
                            <div class="blog-img position-relative overflow-hidden">
                                    <img class="img-fluid" src="{{url('landingpage/img/blog-1.jpg')}}" alt="">
                                ...
                                <div class="p-4">
                                    ...
                                    <a class="text-uppercase" href="{{ url('/detail')}}">Read More <i class="bi bi-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 wow slideInUp" data-wow-delay="0.6s">
                            <div class="blog-item bg-light rounded overflow-hidden">
                                <div class="blog-img position-relative overflow-hidden">
                                    <img class="img-fluid" src="{{url('landingpage/img/blog-1.jpg')}}" alt="">
                                    <a class="position-absolute bottom-0 start-0 bg-dark text-white rounded-end mt-5 py-2 px-4" href="">UI/UX</a>
                                </div>
                                <div class="p-4">
                                    <div class="d-flex mb-3">
                                        <small class="me-3"><i class="far fa-user text-primary me-2"></i>John Doe</small>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="mb-5 wow slideInUp" data-wow-delay="0.1s">
                        ...
                        <div class="link-animated d-flex flex-column justify-content-start">
                            <a class="h5 fw-semi-bold bg-light rounded py-2 px-3 mb-2" href="#">
                                <i class="bi bi-arrow-right me-2"></i>UI/UX</a>
                        </div>
                    </div>
                    <!-- Category End -->
